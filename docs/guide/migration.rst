...
.. code-block:: python
  ...
  from stable_baselines3_fyp.common.env_util import make_atari_env, make_vec_env
  from stable_baselines3_fyp.common.utils import set_random_seed

instead of ``from stable_baselines3_fyp.common import make_atari_env``
...
.. warning::
	...
	Use ``stable_baselines3_fyp.common.sb2_compat.rmsprop_tf_like.RMSpropTFLike`` optimizer to match the results
